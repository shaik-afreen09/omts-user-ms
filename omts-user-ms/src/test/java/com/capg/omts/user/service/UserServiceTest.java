...
class UserServiceTest {
	...
	@BeforeAll
	  void setUp()
	{
		admin=new Admin(1980,"afreen", "09878987", LocalDate.of(1998,9,28),"9988778899");
		customer=new Customer(12987656, "shaik", "98765678", LocalDate.of(1998,6,5), new ArrayList<>(), "9874563214");
